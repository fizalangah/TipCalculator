...
export default function Tipcalculator() {
  ...
  return (
    <div className="flex justify-center items-center text-left">
        <div className="h-[500px] lg:w-[400px] w-[300px] bg-white border-4 rounded-xl border-white  mt-[100px] shadow-xl ">
           ...
           <div className="ml-[30px] mt-[20px]  flex flex-col lg:w-[350px] md:w-[250px] w-[150px] font-semibold">
           <label>Bill Amount</label>
           <input type="number"
           onChange={handleBillAmountChange}
            placeholder="Enter bill amount " className="rounded-xl p-2 outline-none" />
           </div>
           <div className="ml-[30px] mt-[20px]  flex flex-col lg:-[350px] md:w-[250px]  w-[150px]font-semibold">
           ...
           onChange={handleTipPercentageChange}
            placeholder="Enter Tip percentage " className="rounded-xl p-2 outline-none" />
             ...
             <div className="ml-[30px] mt-[30px] flex flex-row lg:gap-x-40 gap-x-[50px] font-semibold">
             <h3>Tip Amount</h3> <p>{` $${tipAmount.toFixed(2)}`}</p>
             </div>
             <div className="ml-[20px] mt-[30px] flex flex-row lg:gap-x-40  gap-x-[50px] font-semibold">
